...
const getSampleData = (): ReportFormData => ({
  ...
  summary: 'Comprehensive analysis of the global telemedicine market, covering market size, growth trends, key players, regional insights, and future opportunities. This report provides in-depth coverage of telemedicine adoption across healthcare sectors, technological advancements, regulatory landscape, and competitive dynamics shaping the industry through 2031.',
  ...
  sections: {
    ...
    tableOfContents: '<h2>Table of Contents</h2><ol><li>Executive Summary</li><li>Research Methodology</li><li>Market Overview<ul><li>Market Definition</li><li>Market Evolution</li><li>Value Chain Analysis</li></ul></li><li>Market Dynamics<ul><li>Drivers</li><li>Restraints</li><li>Opportunities</li><li>Challenges</li></ul></li><li>Market Segmentation<ul><li>By Service Type</li><li>By Delivery Mode</li><li>By End User</li><li>By Geography</li></ul></li><li>Competitive Landscape<ul><li>Market Share Analysis</li><li>Company Profiles</li><li>Strategic Developments</li></ul></li><li>Regional Analysis</li><li>Future Outlook and Opportunities</li><li>Appendix</li></ol>',
  },
  faqs: [
    {
      question: 'What is the projected market size for telemedicine by 2031?',
      answer: 'The global telemedicine market is projected to reach $286.2 billion by 2031, growing from $87.4 billion in 2024 at a CAGR of 18.4%.',
    },
    {
      question: 'Which region dominates the telemedicine market?',
      answer: 'North America currently dominates the telemedicine market with a 42% market share, driven by advanced infrastructure, favorable policies, and high adoption rates.',
    },
    {
      question: 'What are the main types of telemedicine services?',
      answer: 'The main types include teleconsultation, telemonitoring, teleradiology, telepathology, and telepsychiatry, with teleconsultation being the largest segment.',
    },
    {
      question: 'Who are the leading players in the telemedicine market?',
      answer: 'Leading players include Teladoc Health (15.3% market share), American Well/Amwell (12.7%), MDLive (9.2%), Doctor on Demand (7.8%), and Grand Rounds (5.4%).',
    },
  ],
  metadata: {
    metaTitle: 'Global Telemedicine Market Report 2024-2031 | $286.2B by 2031',
    metaDescription: 'Comprehensive telemedicine market research covering size, growth, trends, and forecasts. Market projected to reach $286.2B by 2031 at 18.4% CAGR. Analysis of key players, regional insights, and opportunities.',
    keywords: ['telemedicine market', 'telehealth', 'virtual healthcare', 'remote patient monitoring', 'teleconsultation', 'digital health', 'healthcare IT'],
    canonicalUrl: '',
    ogTitle: 'Global Telemedicine Market Research Report 2024-2031',
    ogDescription: 'In-depth analysis of the $87.4B telemedicine market growing to $286.2B by 2031. Coverage of market trends, key players, regional analysis, and growth opportunities.',
    ogImage: '',
    ogType: 'article',
