    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>e.g., &quot;index, follow&quot;</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold">Open Graph & Twitter</h3>
            <div className="grid grid-cols-2 gap-4">
              <FormField
                control={form.control}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>1200x630px recommended</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
